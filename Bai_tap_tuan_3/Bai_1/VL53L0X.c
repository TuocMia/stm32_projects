...
extern uint8_t I2C_WriteReg(uint8_t dev_addr, uint8_t reg_addr, uint8_t data);
extern uint8_t I2C_ReadReg(uint8_t dev_addr, uint8_t reg_addr);
extern void I2C_WriteMulti(uint8_t dev_addr, uint8_t reg_addr, uint8_t *data, uint8_t count);
extern void I2C_ReadMulti(uint8_t dev_addr, uint8_t reg_addr, uint8_t *data, uint8_t count);
...
{
    I2C_WriteReg(g_i2cAddr, reg, value);
}
...
void writeReg16Bit(uint8_t reg, uint16_t value)
{
    ...
    buf[0] = (value >> 8) & 0xFF;
    buf[1] = value & 0xFF;
    I2C_WriteMulti(g_i2cAddr, reg, buf, 2);
}
...
void writeReg32Bit(uint8_t reg, uint32_t value)
{
    ...
    buf[2] = (value >> 8) & 0xFF;
    buf[3] = value & 0xFF;
    I2C_WriteMulti(g_i2cAddr, reg, buf, 4);
}

uint8_t readReg(uint8_t reg)
{
    return I2C_ReadReg(g_i2cAddr, reg);
}

uint16_t readReg16Bit(uint8_t reg)
{
    uint8_t buf[2];
    I2C_ReadMulti(g_i2cAddr, reg, buf, 2);
...
{
    uint8_t buf[4];
    I2C_ReadMulti(g_i2cAddr, reg, buf, 4);
    return ((uint32_t)buf[0] << 24) | ((uint32_t)buf[1] << 16) | ((uint32_t)buf[2] << 8) | buf[3];
}

void writeMulti(uint8_t reg, uint8_t const *src, uint8_t count)
{
    I2C_WriteMulti(g_i2cAddr, reg, (uint8_t *)src, count);
}

void readMulti(uint8_t reg, uint8_t *dst, uint8_t count)
{
    I2C_ReadMulti(g_i2cAddr, reg, dst, count);
}
